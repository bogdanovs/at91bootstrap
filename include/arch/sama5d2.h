...
/* 37 */
#define	AT91C_ID_PWM		38	/* Pulse Width Modulation Controller0 (ch. 0,1,2,3) */
/* 39 */
...
#define	AT91C_ID_PDMIC		48	/* Pulse Density Modulation Interface Controller */
...
#define	AT91C_ID_SAIC		61	/* Secured Advanced Interrupt Controller */
...
#define	AT91C_ID_SDMMC0_TIMER	71	/* Secure Data Memory Card Controller 0 */
#define	AT91C_ID_SDMMC1_TIMER	72	/* Secure Data Memory Card Controller 1 */
/* 73 */
...
#define CHIPID_CIDR		0x00
#define CHIPID_EXID		0x04
 ...
 */
#define SAMA5D2_CIDR		0x0a5c08c0
#define SAMA5D21CU_EXID		0x0000005a
#define SAMA5D225C_D1M_EXID	0x00000053
#define SAMA5D22CU_EXID		0x00000059
#define SAMA5D22CN_EXID		0x00000069
#define SAMA5D23CU_EXID		0x00000058
#define SAMA5D24CX_EXID		0x00000004
#define SAMA5D24CU_EXID		0x00000014
#define SAMA5D26CU_EXID		0x00000012
#define SAMA5D27C_D1G_EXID	0x00000033
#define SAMA5D27C_D5M_EXID	0x00000032
#define SAMA5D27C_LD1G_EXID	0x00000061
#define SAMA5D27C_LD2G_EXID	0x00000062
#define SAMA5D27CU_EXID		0x00000011
#define SAMA5D27CN_EXID		0x00000021
#define SAMA5D28C_D1G_EXID	0x00000013
#define SAMA5D28C_LD1G_EXID	0x00000071
...
#define	AT91C_BASE_SHDWC	(AT91C_BASE_SYSC + 0x10)
...
#define	H64MX_SLAVE_CACHE_L2		11	/* Internal SRAM 128K (Cache L2) */
